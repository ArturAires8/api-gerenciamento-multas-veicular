package com.algaworks.algatransito.api.exceptionhandle;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        Map<String, String> filds = ex.getBindingResult().getAllErrors()
                .stream()
    ...
    public ProblemDetail handleDataIntergrity(DataIntegrityViolationException e) {
